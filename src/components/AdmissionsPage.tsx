...
const AdmissionsPage: React.FC<AdmissionsPageProps> = ({ school, refreshData, onEnrollStudent }) => {
    ...
    return (
        <div className="space-y-6 h-full flex flex-col">
            <div className="card bg-base-100 shadow flex-shrink-0">
                <div className="card-body p-4">
                  <div className="flex justify-between items-center mb-4">
                      <h3 className="card-title text-secondary">Admissions Pipeline ({school.applicants.filter(a => a.status !== ApplicationStatus.Enrolled).length})</h3>
                   ...
                   <div className="stats stats-vertical lg:stats-horizontal shadow-inner bg-base-200/50">
